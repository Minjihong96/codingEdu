 ...
 .custom-hover {
        ...
        <div class="container"><a class="navbar-brand" href="${pageContext.request.contextPath}/pstumain"><img src="assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
				...
				<li class="nav-item px-2"><a class="nav-link" aria-current="page" href="\stmyPage">마이페이지</a></li>
        ...
        <div class="bg-white p-3 rounded shadow-sm" style="min-height: 300px;">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2">
              <a class="nav-link text-primary mb-4 font-sans fw-bold" href="${pageContext.request.contextPath}/stMyInfoList?memPrid=${sessionScope.loginUser.memPrid}">내 정보 확인</a>
            </li>
            <li class="nav-item mb-2">
  ...
  <div class="bg-white p-4 rounded shadow-sm position-relative">
    ...
    <div class="text-end mt-3">
      <a href="submitPage" id="regBtn" class="btn btn-primary custom-hover">과제 제출</a>
    </div>

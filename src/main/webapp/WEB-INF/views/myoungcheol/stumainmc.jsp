...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#goMyPage").click(function(){
			location.href="stmyPage2"	
   	})
	
		$("#goCourseDet").click(function(){
			location.href="courseDet"	
   	})
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo-n.png"  height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="courseDet" id="goCourseDet">강의상세</a></li>
            </ul>
            <c:choose>

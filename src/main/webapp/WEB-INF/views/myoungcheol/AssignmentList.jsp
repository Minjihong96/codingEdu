  ...
  <body>
    ...
    <main class="main" id="top">
     ...
     <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo-n.png"  height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="\stmyPage2">마이페이지</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="user-research.html">student</a></li>
            </ul>
            <c:choose>
	  ...
	  <h1 class="mb-4 mt-5  text-center" style="font-family: sans-serif;">과제 목록</h1>
          <%-- 
    ...
    <table class="table table-hover text-center">
         <colgroup>
        <col style="width: 10%;">  <%-- 1. 강의번호 --%>
        <col style="width: 10%;">  <%-- 2. 과제번호 --%>
        <col style="width: 20%;">  <%-- 3. 과제명 --%>
        <col style="width: 40%;">  <%-- 4. 문제 --%>
        <col style="width: 20%;">  <%-- 4. 과제제출하기 --%>
    </colgroup>
	...
	--%>
            <c:forEach var="as" items="${asg}">
                <tr>
                    <%-- 각 필드를 테이블 데이터(td)로 표시 --%>
                    <td>${as.materialId}</td>
                    <td>${as.assignmentId}</td>
                    <td>${as.title}</td>
                    <td>${as.content}</td>
                    <td>
                        <fmt:formatDate value="${as.dueDate}" pattern="yyyy-MM-dd"/>
                    </td>
                    <td>
                        <%-- 강의아이디 고유번호(memPrid)를 파라미터로 넘겨주는
                         강의 제출폼으로 이동되는 링크--%>
                          
                        <a href="submitPage?materialId=${as.materialId}" 

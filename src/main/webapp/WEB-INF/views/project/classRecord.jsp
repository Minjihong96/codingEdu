	...
	<section class="pb-11 pt-7 bg-600">
	  <div class="container d-flex justify-content-center">
	    <div class="p-5 bg-white rounded-3 shadow" style="max-width: 500px; width: 100%;">
	      <h1 class="mb-4 text-center" style="font-family: Sans-serif">수업 기록</h1>
     		<form id="pclassRecordForm" method="post" action="pclassRecordInsert">
     		<!-- 
     		<div class="mb-4">
	          	<label class="form-label">학생</label>
	          	<select class="form-select"  name="studentName">
	            	<option value="1">밀탱크</option>
	            	<option value="2">밀카우</option>
	            	<option value="3">어피치</option>
	          	</select>
	        </div>
	        -->
	        <div class="mb-3">
	          	<label class="form-label">학생 ID</label>
          		<input class="form-control" type="text" name="memPrid" id="memPrid" required />
          		<div id="idCheck" class="error-msg"></div>
	        </div>
	        
	        <div class="mb-3">
	          	<label class="form-label">수업 날짜</label>
	         	<input class="form-control" type="date" name="classDate" id="classDate" required />
	        </div>
	        
	        <div class="mb-3">
	          	<label class="form-label">수업 내용</label>
          		<input class="form-control" type="text" name="classContents" id=""classContents"" required />
          		<div id="idCheck" class="error-msg"></div>
	        </div>
	        <div class="mb-3">
	        ...
	        <div class="mb-3">
		        ...
		        <input class="form-control" type="text" name="sessionNumber" id="sessionNumber" required />
	        </div>	       
	        <div class="mb-3">
	        ...
	        <div class="mb-3">
          		...
          		<input class="form-control" type="text" name="etc" id="etc"/>
	        </div>
	        <div class="text-center">
	          <button class="btn btn-primary w-100" type="submit" id="c">저장</button>
	        </div>
	      </form>
	    </div>
	  </div>

 ...
 .custom-hover {
        ...
        <div class="bg-white p-3 rounded shadow-sm" style="min-height: 300px;">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2">
              <a class="nav-link text-primary mb-4 font-sans fw-bold" href="${pageContext.request.contextPath}/pgetMemberDetail?memPrid=${sessionScope.loginUser.memPrid}">내 정보 확인</a>
            </li>
            <li class="nav-item mb-2">
              <a class="nav-link text-primary mb-4 font-sans fw-bold" href="${pageContext.request.contextPath}/pstmyCourse">나의 수강 목록 확인</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="bg-white p-4 rounded shadow-sm position-relative">
    ...
    <div class="text-end mt-3">
      <a href="${pageContext.request.contextPath}/psubmitPage" id="regBtn" class="btn btn-primary custom-hover">과제 제출</a>
    </div>

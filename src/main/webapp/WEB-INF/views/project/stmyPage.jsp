        ...
        <div class="bg-white p-3 rounded shadow-sm" style="min-height: 300px;">
          ...
          <ul class="nav flex-column">
           ...
           <li class="nav-item mb-2">      
              <a class="nav-link text-primary mb-4 font-sans fw-bold" aria-current="page" href="${pageContext.request.contextPath}/pgetMemberDetail?memPrid=${sessionScope.loginUser.memPrid}">내 정보 확인</a>
           </li>
            <li class="nav-item mb-2">

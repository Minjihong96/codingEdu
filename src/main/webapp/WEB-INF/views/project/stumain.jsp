  ...
  <body>
    ...
    <div class="carousel-indicators">
      ...
      <section>
        <div class="container">
          <div class="row">
            <h1 class="text-center mb-5 fw-bold" style="font-family:Nanum Gothic;"> 강의 목록</h1>
            <c:forEach var="mat" items="${matList}">
            <div class="col-md-4 mb-4">
             <a href="pstmatDetail?materialId=${mat.materialId}" style="text-decoration:none; color:inherit;">

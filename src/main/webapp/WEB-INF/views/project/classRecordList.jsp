...
<head>
  ...
  $(document).ready(function(){
		$("#regBtn").click(function(){
			location.href="pcustomerInsert"
		})
		/*
		$("#editBtn").click(function(){
			location.href="pclassRecordEdit"
		})
		*/
  	...
  	function updateRecord(idVal){
		alert(idVal)
		location.href="precordDetail?recordId="+idVal
	}
  </script>
</head>
<body>
  ...
  <div class="container">
	<form id="frm01" class="form"> <%-- post 요청 body ename=@@&job=@@ --%>
  	<nav class="navbar navbar-expand-lg navbar-light sticky-top py-3">
	    <input placeholder="학생명" name="classContents" value=""  class="form-control mr-sm-2" />
    ...
    <tbody>
        ...
        <c:forEach var="cr" items="${classRecordList}">
            ...
            <tr>
                ...
                <td>
	                <!-- 수정 버튼 -->
	                <form method="get" action="pclassRecordEdit" style="display:inline;">
	                ...
	                <!-- 삭제 버튼 -->
	                <form method="post" action="pclassRecordDelete" style="display:inline;" 

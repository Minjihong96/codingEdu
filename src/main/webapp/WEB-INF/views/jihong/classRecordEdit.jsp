  ...
  <script type="text/javascript">
	 ...
	 $(document).ready(function(){
            $("#editBtn").click(function(e){
                ...
                if(confirm("수정하시겠습니까?")){
                    $("#editForm").attr("action", "classRecordList"); // 필요시 경로 변경
                    $("#editForm").submit();
                }
            });
        });
...
<section class="bg-primary py-2 d-none d-sm-block">
  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
    </div>
  </nav>
  ...
  <div id = "editForm" class="container mt-5">
    ...
    <form:form method="post" action="${path}/classRecord/edit" modelAttribute="classRecord" class="form">
        ...
        <div class="mb-3">
            ...
            <form:input path="memPrid" class="form-control" value="${classRecord.memPrid != null ? classRecord.memPrid : ''}" />
        </div>
        ...
        <button type="submit" class="btn btn-success" id="editBtn">수정 완료</button>

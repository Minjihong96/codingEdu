          ...
          <div class="row">
            <div class="col-12">
              ...
              <form class="row g-3">
                ...
                <input placeholder="강의 이름" name="title" value=""  class="form-control mr-sm-2" />
          ...
          <c:forEach var="d" items="${dpList}">        
	          <div class="col-md-4 mb-4">
	              <div class="card h-100">
	              	<img class="card-img-top w-100" src="${d.imageUrl}" alt="courses" style="height: 200px; object-fit: contain;" />
	                <div class="card-body">
	                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">${d.title}</h5>

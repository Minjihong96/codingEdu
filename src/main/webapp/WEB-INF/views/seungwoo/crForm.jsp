  ...
  <section class="pb-11 pt-7 bg-600">
    <div class="container d-flex justify-content-center">
      <div class="p-5 bg-white rounded-3 shadow" style="max-width: 500px; width: 100%;">
       ...
       <div class="container">
        <form method="post" action="crInsert">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" type="text" id="subject" name="phone" required />
          </div>
          <div class="mb-3">
            <label class="form-label" for="counselingTime">상담 희망 시간</label>
            <select class="form-select" id="counselingTime" name="counselingTime" required>
          ...
          <div class="text-center">
            <button class="btn btn-primary w-100" type="submit" id="mainBtn">상담 신청</button>
          </div>
        </form>
       </div>

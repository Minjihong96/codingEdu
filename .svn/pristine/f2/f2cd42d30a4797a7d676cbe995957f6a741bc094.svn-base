	    ...
	    <div class="p-5 bg-white rounded-3 shadow" style="max-width:700px; width:100%;">
	      <h1 class="mb-4 text-center" style="font-family: sans-serif;">과제 제출 폼</h1>
              <form id="joinForm" enctype="multipart/form-data"  >
                   <div class="mb-3">
        <label for="subjectName" class="form-label fs-4 fw-bold">과목명</label>
        <input type="text" class="form-control" name="subjectName" id="subjectName" readonly placeholder="html/css" required>
      </div>
          
	        
                <div class="mb-3">
	          	<label for="assignmentContent" class="form-label">과제 내용</label>
          		<textarea class="form-control" name="assignmentContent" id="assignmentContent" rows="13" required></textarea>
	        </div>

        ...
        <div class="container"><a class="navbar-brand" href="${pageContext.request.contextPath}/padminmain"><img src="assets/img/gallery/logo-n.png"  height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/penrList">수강신청목록</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="${pageContext.request.contextPath}/pcrList">무료신청확인</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="${pageContext.request.contextPath}/pgigetMemberList">회원정보리스트</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="${pageContext.request.contextPath}/pgigetMemberDetail?memPrid=${sessionScope.loginUser.memPrid}">회원정보상세</a></li>
            </ul>
            <c:choose>
	    ...
	    <div class="carousel-inner">
	        ...
	        <div class="container">
	          <div class="row align-items-center">
	            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end">
	              <img class="pt-7 pt-md-0 w-100" src="https://kasterra.github.io/images/thumbnails/CSS.png" width="470" alt="hero-header">
	            </div>
	            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
	              <h4 class="fw-bold font-sans-serif">css 고급</h4>
	              <h1 style="font-family:Nanum Gothic;" class="fs-6 fs-xl-7 mb-5 "> 수강하면 내가 css 마스터!</h1>
	              <a class="btn btn-primary me-2" href="#!" role="button">css 마스터 되기</a>
	              <a class="btn btn-outline-secondary" href="#!" role="button">자세히 알아보기</a>
	            </div>
	          </div>
	        </div>
	      </div>
	      ...
	      <div class="carousel-item">
	        <div class="container">
	          <div class="row align-items-center">
	            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end">
	              <img class="pt-7 pt-md-0 w-100" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSH5vwkvquMWefRsdCr7_OOfnI4ED7bPbvnEQ&s" width="470" alt="hero-header-2">
	            </div>
	            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
				  <h4 class="fw-bold font-sans-serif">java 초급</h4>
				  <h1 style="font-family:Nanum Gothic;" class="fs-6 fs-xl-7 mb-5">누구나 쉽게 시작할 수 있는 java 기본강의</h1>
				  <a class="btn btn-primary me-2" href="#!" role="button">java로 랜덤강의듣기</a>
				  <a class="btn btn-outline-secondary" href="#!" role="button">자세히 알아보기</a>
				</div>
	          </div>
	        </div>
	      ...
	      <div class="carousel-item">
	        <div class="container">
	          <div class="row align-items-center">
	            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end">
	              <img class="pt-7 pt-md-0 w-100" src="https://getbootstrap.kr/docs/5.0/assets/brand/bootstrap-social.png" width="470" alt="hero-header-3">
	            </div>
	            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
	              <h4 class="fw-bold font-sans-serif">bootstrap 중급</h4>
	              <h1 style="font-family:Nanum Gothic;" class="fs-6 fs-xl-7 mb-5">부트스트랩5의 기초를 끝내신 분들을 위한 강의입니다!</h1>
	              <a class="btn btn-primary me-2" href="#!" role="button">부트스트랩 유저되기</a>
	              <a class="btn btn-outline-secondary" href="#!" role="button">자세히 알아보기</a>
	            </div>
	          </div>
	        </div>

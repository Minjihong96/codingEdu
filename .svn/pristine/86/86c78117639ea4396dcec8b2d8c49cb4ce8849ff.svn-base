...
<script type="text/javascript">
	$(document).ready(function(){
		$("#goAssignmentList").click(function(){
			location.href="getAssignment"
		})
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo-n.png"  height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="courseDet">student</a></li>
            </ul>
            <c:choose>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <h1 class="mb-6">User Research for User<br />Experience Design</h1>
            </div>
          </div>
        </div>
        <!-- end of .container-->
            ...
            <div class="col-md-4">
              <div class="card">
                <ul class="list-group list-group-flush">
    			  ...
    			  <button class="btn btn-warning btn-sm" id="goAssignmentList">
       				 과제 목록
     				 </button>
   					 </li>
                </ul>
